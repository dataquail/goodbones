...
Each objective of a [campaign](/goodbones/campaigns/getting-started/introduction/) has a ledger:
...
[concession](/goodbones/campaigns/manifest/phases/#changing-a-defined-phase) has
...
A [scalar objective](/goodbones/campaigns/manifest/scalars/)'s
